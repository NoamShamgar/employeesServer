...
app.use(cors({credentials: true, origin: ['https://cinema-project-ui.herokuapp.com','http://localhost:3000']})); // alowwing requests only from port 3000 and including cookies in the transfers
